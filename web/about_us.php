    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                <li>
                    <p class="red">personal Data Developers</p>
                </li>
                <li>
                    <a href="#">
                    ...
                    <div class="col-sm-4 gallery-grids-left">
                        <div class="gallery-grid">
                            <a class="example-image-link" href="images/g1.jpg" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
                                ...
                                <div class="captn">
                                    <h4>Ayu Widya Inggit</h4>
                                    <p>D3-KA / 163210012</p>
									<a href="daftar_pemasok.php">ig : ayuwidyainggit</a>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-4 gallery-grids-left">
                        <div class="gallery-grid">
                            <a class="example-image-link" href="images/g2.jpg" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
                                <img src="images/endah.jpg" alt="" />
                                <div class="captn">
                                    <h4>Endah Sukma Kuncari</h4>
                                    <p>D3-KA /163210006</p>
									
									<a href="https://instagram.com/endahsukmakuncariii?utm_source=ig_profile_share&igshid=1s0cw0355s68v">ig : endahsukmakuncari</a>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-4 gallery-grids-left">
                        <div class="gallery-grid">
                            <a class="example-image-link" href="images/g3.jpg" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
                                <img src="images/annisa.jpg" alt="" />
                                <div class="captn">
                                    <h4>Annisa Fahma Aziza Yekti</h4>
                                    <p>D3-KA / 163210012</p>
									
									<a href="daftar_pemasok.php">ig : annisafahma</a>
                                </div>
                            </a>
                        </div>
                    </div>
