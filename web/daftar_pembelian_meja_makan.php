...
<section id="main-content">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     LAPORAN PEMBELIAN MEJA MAKAN
    </div>
                               <?php  
                                $sql_cek="select b.* , a.nm_pemasok FROM pembelian b, pemasok a where b.id_pemasok=a.id_pemasok AND b.jenis_pembelian='meja_makan' 
        ...
        <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['qty']; ?> &nbsp unit</td>
                                                <td>Rp<?php echo number_format($data['harga'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                <td> Rp<?php echo number_format ($jml, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                            </tr>
                                    <?php 
                                         }
                                        }
