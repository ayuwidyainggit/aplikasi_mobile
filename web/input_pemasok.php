...
include "koneksi.php";
    ...
    $sql="select MAX(id_pemasok) from pemasok";
    ...
    $new_ID = "SU".sprintf("%06s","$no_urut");  //angka yang telah ditambah dengan dengan 1 kemudian  digabung kembali dengan "PM"
...
<section id="main-content">
    <section class="wrapper">
        ...
        <section class="panel">
            ...
            <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Alamat</label>
                        <div class="col-lg-6">
