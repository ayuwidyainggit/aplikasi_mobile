        ...
        <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($data['qty_jual'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                <td>Rp <?php echo number_format($data['harga_satuan'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                <td>Rp <?php echo number_format($data['total_penjualan'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
