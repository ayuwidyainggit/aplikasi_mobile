...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        <li>
            <input type="text" action="daftar_pemasok.php" class="form-control search" name="nm_pemasok" placeholder=" Search">
        </li>
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     DAFTAR PEMASOK
                                ...
                                <?php  
                                        $sql_cek="select * from pemasok ORDER BY id_pemasok ASC";
...
<!--main content end-->
</section><script src="js/bootstrap.js"></script>
