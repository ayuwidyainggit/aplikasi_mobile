...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2018 at 06:15 AM
...
--
-- Database: `aplikasimobile`
--

-- --------------------------------------------------------

--
-- Table structure for table `catatankas`
--
...
--
-- Table structure for table `kartugudang`
--
...
CREATE TABLE `pembelian` (
  ...
  `id_pemasok` varchar(8) NOT NULL,
  `jenis_pembelian` enum('almari','sofa','meja_makan','kursi','kasur') DEFAULT NULL,
  `qty` int(11) NOT NULL,
...
--
-- Table structure for table `penerimaankas`
--
...
--
-- Table structure for table `pengeluarankas`
--
...
CREATE TABLE `penjualan` (
  ...
  `barang` enum('almari','sofa','meja_makan','kursi','kasur') DEFAULT NULL,
...
--
-- Table structure for table `perencanaanusaha`
--
...
--
-- Table structure for table `permintaanbb`
--
...
--
-- Table structure for table `permintaanpembelian`
--
...
--
-- Constraints for table `permintaanbb`
--
ALTER TABLE `permintaanbb`
